...
const translations = {
  welcome: (firstName: string) => ({
    ...
    uz: `Salom ${firstName}! Men universal fayl konverterman.\n\nMenga istalgan fayl yuboring — hujjat, rasm, audio yoki video — va men uni kerakli formatga konvertatsiya qilaman.\n\n📄 Hujjatlar: PDF, DOCX, EPUB, HTML...\n🖼 Rasmlar: PNG, JPG, WEBP, SVG...\n🎵 Audio: MP3, WAV, OGG, FLAC...\n🎬 Video: MP4, MKV, AVI, WEBM...\n\nBoshlash uchun fayl yuboring!`,
    uz_cyrillic: `Салом ${firstName}! Мен универсал файл конвертерман.\n\nМенга исталган файл юборинг — ҳужжат, расм, аудио ёки видео — ва мен уни керакли форматга конвертация қиламан.\n\n📄 Ҳужжатлар: PDF, DOCX, EPUB, HTML...\n🖼 Расмлар: PNG, JPG, WEBP, SVG...\n🎵 Аудио: MP3, WAV, OGG, FLAC...\n🎬 Видео: MP4, MKV, AVI, WEBM...\n\nБошлаш учун файл юборинг!`,
  }),
  chooseLanguage: {
  ...
  conversionExpired: {
    ...
    uz_cyrillic: "⏰ Бу конвертация муддати тугаган. Илтимос, файлни қайтадан юборинг.",
  },
  textMessage: {
    ...
    uz: "Men fayl konverter botman! Menga istalgan fayl yuboring — hujjat, rasm, audio yoki video — va men uni kerakli formatga konvertatsiya qilaman.\n\n/help — barcha qo'llab-quvvatlanadigan formatlar.",
    uz_cyrillic: "Мен файл конвертер ботман! Менга исталган файл юборинг — ҳужжат, расм, аудио ёки видео — ва мен уни керакли форматга конвертация қиламан.\n\n/help — барча қўллаб-қувватланадиган форматлар.",
  },
